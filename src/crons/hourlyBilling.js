...
node_cron_1.default.schedule("0 * * * *", function () { return __awaiter(void 0, void 0, void 0, function () {
    var businesses, _i, businesses_1, biz, users, sizeBytes;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                biz = businesses_1[_i];
                return [4 /*yield*/, user_model_1.User.find({ business: biz._id })];
            case 3:
                users = _a.sent();
                sizeBytes = Buffer.byteLength(JSON.stringify(users));
                return [4 /*yield*/, usageModel_1.UsageModel.updateOne({ business: biz._id }, {
